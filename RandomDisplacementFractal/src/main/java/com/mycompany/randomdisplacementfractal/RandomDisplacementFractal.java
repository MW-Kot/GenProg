//code from https://stackoverflow.com/questions/5531019/perlin-noise-in-java
package com.mycompany.randomdisplacementfractal;
...
public class RandomDisplacementFractal {
    ...
    public static void main(String[] args) {
        RandomDisplacementFractal n = new RandomDisplacementFractal(null, 1.0f, 250, 250);
        n.initialise();
        n.printAsCSV();
    }
}